...
namespace Web.Api.BocaSuja.Migrations
{
    ...
    [Migration("20230812225016_EntidadeOfensora-Fix")]
    partial class EntidadeOfensoraFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.BocaSuja.Domain.Entities.EntidadeOfensora", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("ApelidoEntidade")
                        .IsRequired()
                    ...
                    b.Property<DateTimeOffset>("DataHoraAtualizacao")
                        ...
                        .HasComment("Registra a data e hora em que a entidade foi atualizada. Usado para rastrear o momento em que a entidade foi atualizada. É mapeado como uma coluna do tipo datetimeoffset.");
                    ...
                    b.Property<DateTimeOffset>("DataHoraCriacao")
                        ...
                        .HasColumnOrder(2)
                        .HasDefaultValueSql("SYSUTCDATETIME()")
                        .HasComment("Registra a data e hora em que a entidade foi criada. É usado para rastrear o momento em que a entidade ocorreu. É mapeado como uma coluna do tipo datetimeoffset.");
                    ...
                    b.Property<bool>("Inativo")
                        ...
                        .HasColumnOrder(4)
                        .HasComment("Registra se a entidade está inativa ou não, é registrada como um valor 0 para ativo e 1 para inativo.");

                    b.HasKey("Id");

                    b.HasIndex("ApelidoEntidade");

                    b.ToTable("Entidades Ofensoras", (string)null);
                });
