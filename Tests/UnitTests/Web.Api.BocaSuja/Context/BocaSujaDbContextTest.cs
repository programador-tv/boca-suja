...
public class BocaSujaDbContextTest
{
    ...
    )
  {
    ...
    Assert.Multiple(() =>
    {
      ...
      Assert.That(actual: incidenciaPersistida?.EntidadeOfensora, Is.EqualTo(incidencia.EntidadeOfensora));
      ...
      Assert.That(actual: incidenciaPersistida?.DataHoraCriacao, Is.EqualTo(incidencia.DataHoraCriacao));
    });
  }
}
